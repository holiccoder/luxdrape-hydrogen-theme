...
const heroSlides = [
  {
    ...
    subtitle:
      "Free alterations if your curtains don't fit. Plus free shipping over $200.",
  ...
  },
  {
    ...
    subtitle:
      'Premium fabrics, precise measurements, and expert craftsmanship.',
    cta: 'Shop Now',
    link: '/shop',
  },
];
...
const trustFactors = [
  {
    ...
    desc: 'Design consultants since 2005',
  },
  {
    icon: TruckIcon,
    title: 'Quick Delivery',
    desc: '14-day turnaround guaranteed',
  },
  {
    icon: ShieldCheckIcon,
    title: 'Lifetime Support',
    desc: 'We stand behind every product',
  },
  {
    icon: RulerIcon,
    title: 'Perfect Fit Promise',
    desc: 'Free remake if size is wrong',
  },
];
...
const popularStyles = [
  {
    ...
    description:
      'Timeless pinch pleat design that adds sophistication to any room. Available in various fabrics from light-filtering to blackout.',
    image:
  ...
  },
  {
    ...
    description:
      'Soft fabric folds create an elegant look. Choose from flat, hobbled, or relaxed styles in premium fabrics.',
    image:
  ...
  },
  {
    ...
    description:
      'Handcrafted from sustainable materials, bringing organic warmth and texture to your windows.',
    image:
...
const roomCategories = [
  ...
  },
  {
    ...
    name: 'Kitchen',
    image:
      'https://miaoda.feishu.cn/aily/api/v1/files/static/ef5c765748204a14b6ad03baebd04785_ve_miaoda',
    href: '/rooms/kitchen',
    count: '24 Styles',
  },
  {
...
const reviews = [
  {
    ...
    rating: 5,
    text: 'The in-store consultation made all the difference. Expert guidance and perfect results.',
    product: 'Pleated Drapes',
  },
  {
    id: 2,
    name: 'Michael T.',
    location: 'Austin, TX',
    rating: 5,
    text: 'Free in-home measurement was professional and quick. Curtains fit perfectly.',
  ...
  },
  {
    ...
    location: 'Denver, CO',
    rating: 5,
    text: 'The bamboo shades add such warmth to our living room. Beautiful craftsmanship.',
    product: 'Bamboo Woven',
  },
  {
    id: 4,
    name: 'David K.',
    location: 'Seattle, WA',
    rating: 5,
    text: 'Quality exceeded expectations. The blackout feature works perfectly for our nursery.',
    product: 'Blackout Shades',
  },
  {
    id: 5,
    name: 'Emily R.',
    location: 'Chicago, IL',
    rating: 5,
    text: 'Easy to measure, easy to install. Looks like we paid a fortune for custom work.',
    product: 'Pleated Drapes',
  },
  {
    id: 6,
    ...
    location: 'Boston, MA',
    rating: 5,
    text: 'Customer service was outstanding. They helped me choose the perfect color.',
    product: 'Roman Shades',
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          {trustFactors.map((factor) => (
            <div key={factor.title} className="text-center">
              <factor.icon
                className="h-7 w-7 mx-auto mb-3 text-[hsl(220_15%_35%)]"
                strokeWidth={1.5}
              />
      ...
      <div className="w-[95%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Three timeless styles, crafted to perfection for your home.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-10 md:mb-16">
          <div className="text-center md:text-left">
            ...
            <p className="text-white/70 text-base md:text-lg max-w-xl">
              We've simplified the process so you can focus on creating your
              perfect space.
            </p>
          </div>
      ...
      <div className="w-[95%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12 md:mb-16">
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Find the perfect window treatment for every space in your home.
            </p>
          </div>
          <div className="hidden md:flex gap-3">
            <button
      ...
      <div className="w-[95%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12 md:mb-16">
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              See and feel the fabric before you buy. Up to 10 samples free.
            </p>
          </div>
          <Button
            variant="outline"
      ...
      <div className="w-[95%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12 md:mb-16">
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Real homes, real inspiration. Tap to shop products from our
              community.
            </p>
          </div>
          <div className="hidden md:flex gap-3">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Exclusive benefits for interior designers, architects, and
              hospitality professionals. Enjoy up to 25% off, dedicated support,
    ...
    <section className="relative py-20 md:py-28 bg-[hsl(220_15%_18%)] text-white overflow-hidden">
      ...
      <div className="relative w-[95%] max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-medium mb-5">
          Proudly Crafted In Our Factories
        </h2>
        <p className="text-white/70 mb-10 text-lg md:text-xl leading-relaxed">
          Every shade is custom-made to your specifications. We control quality
          at every step to ensure lasting beauty.
        </p>
        <Button
          variant="outline"
