...
const blogPosts = [
  {
    ...
    excerpt:
      'A comprehensive guide to selecting the right fabric, length, and style for your living room, bedroom, kitchen, and more.',
  ...
  },
  {
    ...
    excerpt:
      'From natural textures to bold colors, discover the top curtain and shade trends shaping home interiors this year.',
    category: 'trends',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Compare the pros and cons of two popular curtain fabrics to make an informed decision for your home.',
    category: 'buying-guide',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Expert tips on using window treatments to create the illusion of more space in compact apartments and homes.',
    category: 'decor',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Learn how different colors affect your mood and which shades work best for bedrooms, offices, and living spaces.',
    category: 'color',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Master the art of combining curtains with shades or blinds for a polished, high-end look.',
    category: 'decor',
    image:
  ...
  },
  {
    ...
    excerpt:
      "Explore environmentally conscious fabric choices that don't compromise on style or quality.",
    category: 'trends',
    image:
  ...
  },
  {
    ...
    excerpt:
      'Why velvet is making a comeback and how to incorporate this rich fabric into your interior design.',
    category: 'color',
    image:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Expert tips, design inspiration, and everything you need to know
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/80 mb-8">
              Subscribe to our newsletter for exclusive design tips, new product
