...
export function meta() {
  return [{title: 'How to Measure | LuxDrape'}];
}

export function MeasureGuidePage() {
  return (
    <>
      <style jsx>{`
        .measure-guide {
      ...
      <div className="measure-guide">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-white/80 mb-8">
                Accurate measurements are essential for custom-fit curtains and
                shades. Follow our step-by-step guides to ensure a perfect fit
                every time.
              </p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Different products require different measurement approaches.
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-border bg-card p-8 hover:border-[hsl(220_25%_35%)] transition-colors">
              ...
              <p className="text-muted-foreground mb-6">
                Measure for inside mount, outside mount, or ceiling mount
                installations. Includes fullness calculations for various pleat
                styles.
              </p>
            ...
            <div className="border border-border bg-card p-8 hover:border-[hsl(220_25%_35%)] transition-colors">
              ...
              <p className="text-muted-foreground mb-6">
                Precise measurements for inside mount and outside mount shade
                installations. Critical depth requirements included.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center gap-2 text-sm">
                  <CheckIcon className="h-4 w-4 text-[hsl(220_25%_35%)]" />
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-3">
                      Decide between inside mount (within window frame) or
                      outside mount (wall above window). Outside mount is
                      recommended for better light control and to make windows
                      appear larger.
                    </p>
                    <div className="bg-amber-50 border-l-4 border-amber-400 p-4 text-sm text-amber-800">
                      <strong>Tip:</strong> For outside mount, add 6-12 inches
                      to window width for optimal coverage.
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-3">
                      Measure the width of your window in three places: top,
                      middle, and bottom. Use the widest measurement for outside
                      mount, or the narrowest for inside mount.
                    </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-3">
                      For floor-length curtains, measure from where the rod will
                      be mounted to the floor. Subtract 1/2 inch for clearance,
                      or add extra for a pooling effect.
                    </p>
        ...
        >
          <div className="mb-12">
            ...
            <p className="text-muted-foreground">
              Precise measurements are critical for custom shades. Follow these
              steps exactly.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">
                    Check Window Depth (Inside Mount)
                  </h3>
                  <p className="text-muted-foreground text-sm mb-3">
                    Measure the depth of your window frame from the glass to the
                    outer edge. You need at least 2 inches of depth for inside
                    mount roller shades.
                  </p>
                  <div className="bg-red-50 border-l-4 border-red-400 p-4 text-sm text-red-800">
                    <strong>Critical:</strong> Less than 2" depth requires
                    outside mount.
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mb-3">
                    For inside mount: Measure the exact width of the window
                    opening at the top, middle, and bottom. Record the narrowest
                    measurement. Round down to the nearest 1/8".
                  </p>
                  <p className="text-muted-foreground text-sm">
                    For outside mount: Measure the window width and add 3-4
                    inches to each side (6-8 inches total) for optimal light
                    control.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mb-3">
                    For inside mount: Measure the exact height of the window
                    opening on the left, center, and right. Record the longest
                    measurement.
                  </p>
                  <p className="text-muted-foreground text-sm">
                    For outside mount: Measure from where you want the top of
                    the shade to where you want it to end. Add 2-3 inches above
                    the window frame for mounting.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Check for window cranks, handles, locks, or alarm sensors
                    that might interfere with shade operation. Measure their
                    depth if present.
                  </p>
                </div>
              </div>
        ...
        <section className="w-full bg-muted/30 py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                Learn from others' mistakes to ensure perfect measurements.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card border border-border p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Cloth measuring tapes can stretch and provide inaccurate
                  measurements. Always use a rigid steel tape measure.
                </p>
              </div>
              ...
              <div className="bg-card border border-border p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Windows are rarely perfectly square. Measure width and height
                  in multiple places to account for variations.
                </p>
              </div>
              ...
              <div className="bg-card border border-border p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Inside mount shades need adequate window depth. Always measure
                  depth before choosing inside mount.
                </p>
              </div>
              ...
              <div className="bg-card border border-border p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Window handles, cranks, and locks can prevent proper
                  operation. Always note these when measuring.
                </p>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="bg-[hsl(220_25%_25%)] text-white p-8 md:p-12 text-center">
            ...
            <p className="text-white/80 mb-8 max-w-2xl mx-auto">
              Our measurement experts are here to assist you. Schedule a free
              video consultation or send us photos of your windows for
