...
export function meta() {
  return [{title: 'Trade Program | LuxDrape'}];
}
...
const benefits = [
  {
    ...
    description:
      'Save up to 25% on all custom curtains and shades with your trade account.',
  },
  {
    icon: TruckIcon,
    title: 'Free Shipping',
  ...
  },
  {
    ...
    description:
      'Skip the queue with expedited 7-day production for trade members.',
  },
  {
    icon: UsersIcon,
    title: 'Dedicated Support',
    description:
      'Access to our trade specialists for measurements and consultations.',
  },
];
...
const testimonials = [
  {
    quote:
      'LuxDrape has transformed how I source window treatments for my clients. The quality is exceptional and the trade pricing makes it profitable for my business.',
  ...
  {
    quote:
      'The dedicated support team helped me with complex measurements for a high-rise project. Their expertise saved me time and ensured perfect fit.',
    author: 'Michael Chen',
  ...
  {
    quote:
      "My clients love the custom options and quick turnaround. I've used LuxDrape for over 50 projects and have never been disappointed.",
...
export function TradeProgramPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    toast.success(
      "Application submitted! We'll review and respond within 2 business days.",
    );
    setFormData({
      firstName: '',
      lastName: '',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-8 leading-relaxed">
              Join thousands of interior designers, decorators, and contractors
              who trust LuxDrape for premium custom window treatments. Exclusive
              pricing, dedicated support, and priority service.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Everything you need to deliver exceptional results for your
              clients
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Our trade program is designed for professionals in the design
                and construction industry. If you purchase window treatments for
                clients or projects, you qualify.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                Complete the form below. We'll review your application and
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-white/80 mb-6">
                  Our trade team is here to help. Reach out for personalized
                  assistance with your application or any questions about the
                  program.
                </p>
