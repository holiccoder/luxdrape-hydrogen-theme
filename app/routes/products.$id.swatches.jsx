...
export function meta() {
  return [{title: 'Free Fabric Swatches | LuxDrape'}];
}
...
const productData = {
  ...
  description:
    'Order up to 10 fabric swatches to see and feel our premium materials in your own home before making a decision. Free shipping on all swatch orders.',
  basePrice: 0,
  rating: 4.9,
  reviewCount: 2847,
  features: [
  ...
  images: [
    {
      ...
      alt: 'Fabric swatch samples collection',
    },
    {
      id: '2',
...
const swatchVariants = [
  {
    ...
    price: 0,
    description:
      'Choose up to 6 fabric samples from our core collection. Perfect for initial color matching.',
    maxSwatches: 6,
    icon: PackageIcon,
  },
  {
    ...
    price: 15,
    description:
      'Choose up to 10 samples including premium fabrics and exclusive colors. Includes fabric care guide.',
    maxSwatches: 10,
    icon: SparklesIcon,
  },
];
...
const reviewsData = [
  {
    ...
    title: 'So helpful!',
    content:
      'Being able to see the colors in my own lighting made all the difference. Saved me from ordering the wrong shade.',
    verified: true,
  },
  {
    id: '2',
    ...
    rating: 5,
    date: '2024-02-18',
    title: 'Great quality samples',
    content:
      'The swatches are generous size and really show the fabric texture. Fast shipping too.',
    verified: true,
  },
  {
    id: '3',
    ...
    title: 'Free and fast',
    content:
      "Can't believe these are free! Ordered on Monday, arrived Wednesday. Excellent service.",
    verified: true,
  },
  {
    id: '4',
    ...
    rating: 5,
    date: '2024-02-12',
    title: 'Premium kit worth it',
    content:
      'Got the premium kit for the extra fabrics. The care guide was a nice bonus.',
    verified: true,
  },
  {
    id: '5',
    ...
    content:
      'Used the swatches to match my wall color perfectly. The linen natural was exactly what I needed.',
    verified: true,
  },
  {
    id: '6',
    ...
    content:
      'Order these before you buy curtains. Colors on screen can be deceiving.',
    verified: true,
  },
];
...
const ProductDetailSwatchesPage = () => {
  ...
  const handleSwatchToggle = (fabricId) => {
    setSelectedSwatches((prev) => {
      ...
      if (prev.length >= selectedVariant.maxSwatches) {
        toast.error(
          `You can select up to ${selectedVariant.maxSwatches} swatches for this kit`,
        );
        return prev;
      }
          ...
          <div className="lg:sticky lg:top-24 lg:self-start space-y-4">
            <div className="relative aspect-[4/5] bg-gray-100 overflow-hidden">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1.5 text-xs font-medium bg-emerald-600 text-white">
                  FREE
                </span>
              </div>
              <button
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-500">
                    {selectedVariant.maxSwatches} samples max
                  </span>
                </div>
                <RadioGroup
              ...
              <div className="space-y-3 pt-4 border-t border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-sm ${selectedSwatches.length >= selectedVariant.maxSwatches ? 'text-emerald-600 font-medium' : 'text-gray-500'}`}
                  >
                    {selectedSwatches.length} / {selectedVariant.maxSwatches}{' '}
                    selected
                  </span>
                </div>
                  ...
                  {availableFabrics.map((fabric) => {
                    ...
                    return (
                      <button
                        key={fabric.id}
                        onClick={() =>
                          !isDisabled && handleSwatchToggle(fabric.id)
                        }
                        disabled={isDisabled}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Everything you need to know about our free fabric swatch program.
            </p>
          </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500 font-normal">
                      Simple steps to get your free fabric samples
                    </p>
                  </div>
                </div>
              </AccordionTrigger>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div className="p-5 bg-gray-50 rounded-md text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Choose up to 10 fabric samples from our collection
                    </p>
                  </div>
                  <div className="p-5 bg-gray-50 rounded-md text-center">
                    <div className="w-12 h-12 bg-slate-800 text-white rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Basic kit is free. Premium kit includes extra fabrics.
                    </p>
                  </div>
                  <div className="p-5 bg-gray-50 rounded-md text-center">
                    <div className="w-12 h-12 bg-slate-800 text-white rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Receive your swatches in 1-2 business days
                    </p>
                  </div>
                </div>
              </AccordionContent>
              ...
              <AccordionTrigger className="px-6 py-5 hover:no-underline hover:bg-gray-50 [&[data-state=open]]:bg-gray-50">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500 font-normal">
                      Details about your swatch samples
                    </p>
                  </div>
                </div>
              </AccordionTrigger>
