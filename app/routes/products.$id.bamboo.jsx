...
export function meta() {
  return [{title: 'Natural Bamboo Woven Shades | LuxDrape'}];
}
...
const productData = {
  ...
  description:
    'Handcrafted from sustainably harvested bamboo and natural grasses, our woven shades bring organic texture and warmth to any space. Each shade features unique variations in grain and color, making every piece truly one-of-a-kind.',
  basePrice: 159.99,
  ...
  colors: [
    {
      ...
      hex: '#C4A77D',
      image:
        'https://miaoda.feishu.cn/aily/api/v1/files/static/908556c7998b43c388eedade2bd694e3_ve_miaoda',
    },
    {
      id: 'honey',
      name: 'Honey Oak',
  ...
  images: [
    {
      id: '1',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/908556c7998b43c388eedade2bd694e3_ve_miaoda',
      alt: 'Natural bamboo shades in living room',
    },
    {
      id: '2',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/ec5e95197cbd459f9ddc49da58421506_ve_miaoda',
      alt: 'Light filtering comparison',
    },
    {
      id: '3',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/374fd1c04ee445b2a6f8e62b5b3933ea_ve_miaoda',
      alt: 'Bamboo texture detail',
    },
    {
      id: '4',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/d6e513cd18d543ba880d3432113b8457_ve_miaoda',
      alt: 'Shades in different lighting',
    },
  ],
  opacityLevels: [
    {
      ...
      opacity: 25,
      description:
        'Soft, diffused light creates a warm glow while maintaining privacy',
  ...
  lightComparison: {
    morning:
      'https://miaoda.feishu.cn/aily/api/v1/files/static/ec5e95197cbd459f9ddc49da58421506_ve_miaoda',
    afternoon:
      'https://miaoda.feishu.cn/aily/api/v1/files/static/d6e513cd18d543ba880d3432113b8457_ve_miaoda',
    evening:
      'https://miaoda.feishu.cn/aily/api/v1/files/static/374fd1c04ee445b2a6f8e62b5b3933ea_ve_miaoda',
  },
};
...
const reviewsData = [
  {
    ...
    rating: 5,
    date: '2024-02-20',
    title: 'Beautiful natural light!',
    content:
      'Love how the light filters through these shades. The sheer option gives such a warm, natural glow in my living room.',
    verified: true,
    helpful: 28,
  },
  {
    ...
    rating: 5,
    date: '2024-02-15',
    title: 'Perfect opacity options',
    content:
      "Got the privacy lining for our bedroom and it's exactly what we needed. Still gets that beautiful texture but blocks enough light for sleeping.",
    verified: true,
    helpful: 22,
  },
];

const OpacityIndicator = ({level}) => {
    ...
    <div className={`p-4 md:p-6 rounded-2xl border-2 ${getLevelColor(level)}`}>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs md:text-sm font-medium uppercase tracking-wide opacity-80">
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${mountType === 'inside' ? 'bg-primary text-primary-foreground' : 'bg-background border border-border hover:border-primary'}`}
        >
          Inside Mount
        </button>
        <button
          onClick={() => onMountTypeChange('outside')}
          className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${mountType === 'outside' ? 'bg-primary text-primary-foreground' : 'bg-background border border-border hover:border-primary'}`}
        >
          Outside Mount
        </button>
      </div>
        ...
        {mountType === 'inside' ? (
          ...
          <g>
            ...
            <text
              ...
              textAnchor="middle"
              className="text-xs fill-muted-foreground"
              transform="rotate(90, 405, 150)"
            >
              Height +3-4in overlap
            </text>
          </g>
        )}
        <defs>
...
const LightComparison = () => {
  ...
  const timeOptions = [
    {
      ...
      label: 'Morning Light',
      icon: SunIcon,
      description: 'Soft, warm morning glow',
    },
    {
      id: 'afternoon',
      label: 'Afternoon Sun',
      icon: SunIcon,
      description: 'Bright, direct sunlight',
    },
    {
      id: 'evening',
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <h4 className="font-medium text-sm md:text-base">
          See How Light Transforms Your Space
        </h4>
          ...
          {timeOptions.map((time) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap transition-colors ${timeOfDay === time.id ? 'bg-primary text-primary-foreground' : 'bg-background border border-border hover:border-primary'}`}
              >
...
const MeasurementCalculator = ({mountType}) => {
  ...
  const calculate = () => {
    ...
    if (mountType === 'inside') {
      ...
      setResult({width: (w + 3).toFixed(2), height: (h + 4).toFixed(2)});
    }
  };
  return (
...
export default function BambooShadesPage() {
  ...
  const [openAccordion, setOpenAccordion] = useState('opacity');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-5">
            <div className="space-y-2">
              <Badge
                variant="outline"
                className="rounded-full text-xs font-medium text-emerald-600 border-emerald-200 bg-emerald-50"
              >
            ...
            <div className="space-y-3">
              <Label className="text-sm font-medium">
                Light Control Level: {selectedOpacity.name}
              </Label>
              <div className="space-y-3">
                {productData.opacityLevels.map((level) => (
                  <div
                    key={level.id}
                    className={`p-3 md:p-4 rounded-xl border-2 cursor-pointer transition-all ${selectedOpacity.id === level.id ? 'border-primary bg-primary/5' : 'border-border hover:border-muted-foreground'}`}
                    onClick={() => setSelectedOpacity(level)}
                  >
            ...
            <div className="space-y-3">
              <Label className="text-sm font-medium">
                Natural Material: {selectedColor.name}
              </Label>
              <div className="flex gap-3 flex-wrap">
                {productData.colors.map((color) => (
                  <button
                    ...
                    className={`relative w-12 h-12 md:w-14 md:h-14 rounded-xl border-2 transition-all ${selectedColor.id === color.id ? 'border-primary ring-2 ring-primary ring-offset-2' : 'border-border hover:border-muted-foreground'}`}
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-3 py-2">
              <div className="flex flex-col items-center text-center gap-1 p-2 md:p-3 rounded-xl bg-emerald-50 border border-emerald-100">
                ...
                <span className="text-[10px] md:text-xs text-emerald-700">
                  Eco-Friendly
                  <br />
                  Materials
                </span>
              ...
              <div className="flex flex-col items-center text-center gap-1 p-2 md:p-3 rounded-xl bg-amber-50 border border-amber-100">
                ...
                <span className="text-[10px] md:text-xs text-amber-700">
                  Light
                  <br />
                  Control
                </span>
              ...
              <div className="flex flex-col items-center text-center gap-1 p-2 md:p-3 rounded-xl bg-blue-50 border border-blue-100">
                ...
                <span className="text-[10px] md:text-xs text-blue-700">
                  Lifetime
                  <br />
                  Warranty
                </span>
            ...
            <AccordionContent className="pb-6">
              <div className="space-y-6">
                <p className="text-sm text-muted-foreground">
                  Our bamboo shades offer four distinct opacity levels to
                  perfectly match your lighting needs. The natural weave creates
                  beautiful light patterns while providing the privacy you want.
                </p>
                <LightComparison />
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {productData.opacityLevels.map((level) => (
                    <div
                      key={level.id}
                      className="p-3 md:p-4 rounded-xl bg-accent/30 space-y-2"
                    >
                      <div className="w-full h-2 rounded-full overflow-hidden bg-accent">
                        <div
                          className={`h-full ${level.opacity <= 25 ? 'bg-amber-300' : level.opacity <= 50 ? 'bg-amber-400' : level.opacity <= 75 ? 'bg-amber-500' : 'bg-amber-600'}`}
                          style={{width: `${level.opacity}%`}}
                        />
                      </div>
                      ...
                      <p className="text-[10px] md:text-xs text-muted-foreground">
                        {level.lightTransmission} light passes through
                      </p>
                    </div>
                  ))}
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm text-amber-900">
                        Not sure which opacity?
                      </p>
                      <p className="text-xs md:text-sm text-amber-700 mt-1">
                        Order our FREE fabric swatch kit to see all opacity
                        options in your own space. Natural lighting varies
                        throughout the day, and our samples help you make the
                        perfect choice.
                      </p>
                    </div>
                  </div>
          ...
          <AccordionItem value="materials" className="border-b border-border">
            ...
            <AccordionContent className="pb-6">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Each shade is handcrafted using traditional techniques passed
                  down through generations. We source our bamboo from
                  responsibly managed forests and ensure fair wages for our
                  artisan partners.
                </p>
              </div>
            </AccordionContent>
              ...
              <table className="w-full text-sm">
                <tbody className="divide-y divide-border">
                  ...
                  <tr>
                    ...
                    <td className="py-3 font-medium">12&quot; - 96&quot;</td>
                  </tr>
                  <tr>
                    <td className="py-3 text-muted-foreground">
                      Min/Max Height
                  ...
                  <tr>
                    ...
                    <td className="py-3 font-medium">
                      4 levels (Sheer to Blackout)
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3 text-muted-foreground">Warranty</td>
                    <td className="py-3 font-medium">Lifetime Limited</td>
                  </tr>
                </tbody>
              </table>
            </AccordionContent>
