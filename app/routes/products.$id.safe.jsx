...
export function meta() {
  return [{title: 'Cordless Woven Wood Shades | LuxDrape'}];
}
  ...
  images: [
    {
      ...
      alt: 'Natural woven wood shades in nursery',
    },
    {
      id: '2',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/aee074c0d7ac42a9b8d0f728977ee190_ve_miaoda',
      alt: 'Child-safe cordless mechanism detail',
    },
    {
      id: '3',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/374fd1c04ee445b2a6f8e62b5b3933ea_ve_miaoda',
      alt: 'Artisan handweaving process',
    },
    {
      id: '4',
      url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/d6e513cd18d543ba880d3432113b8457_ve_miaoda',
      alt: 'Natural shades in living room',
    },
  ],
  liningOptions: [
    {
      id: 'unlined',
      name: 'Unlined - Natural Light',
      price: 0,
      description: 'Beautiful filtered light, showcases natural texture',
    },
    {
      id: 'privacy',
      name: 'Privacy Lining',
      price: 25,
      description: 'Blocks visibility while maintaining warm glow',
    },
    {
      id: 'blackout',
      name: 'Blackout Lining',
      price: 45,
      description: 'Complete light blockage for nurseries and bedrooms',
    },
  ],
  safetyFeatures: [
    {
      ...
      description: 'No exposed cords eliminates strangulation hazard',
    },
    {
      icon: ShieldIcon,
      title: 'WCSC Certified',
      description: 'Meets all Window Covering Safety Council standards',
    },
    {
      icon: HandHelpingIcon,
      title: 'Smooth-Lift System',
      description: 'Effortless operation safe for little hands',
    },
  ],
  materialStory: {
...
const fabricSwatches = [
  ...
  },
  {
    ...
    name: 'Honey Oak',
    color: '#D4A574',
    material: 'Bamboo/Grass Blend',
  },
  {
    id: 'swatch-3',
    name: 'Driftwood',
    color: '#9B8B7A',
    material: 'Jute/Bamboo',
  },
  {
    id: 'swatch-4',
    name: 'Dark Espresso',
...
const reviewsData = [
  {
    ...
    rating: 5,
    date: '2024-02-20',
    title: 'Perfect for nursery!',
    content:
      'Love that these are truly cordless. The natural texture is beautiful and the blackout lining works great for nap time.',
    verified: true,
    helpful: 32,
    image: null,
  },
  {
    ...
    rating: 5,
    date: '2024-02-15',
    title: 'Safe and beautiful',
    content:
      'Ordered these specifically for child safety. The quality is outstanding and installation was straightforward.',
    verified: true,
    helpful: 28,
    image: null,
  },
  {
    ...
    content:
      'So happy to find sustainable window coverings. The swatches helped us pick the perfect color.',
    verified: true,
    helpful: 24,
    image:
      'https://miaoda.feishu.cn/aily/api/v1/files/static/323d2b04633e42088ff6fb19e300a7fe_ve_miaoda',
  },
];
...
const MotorDemo = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-accent/50 to-accent/30 rounded-2xl p-6 space-y-4">
      ...
      <div
        className="relative bg-sky-100 rounded-xl overflow-hidden"
        style={{height: '200px'}}
      >
        <div className="absolute inset-4 border-4 border-white rounded-lg overflow-hidden">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  'repeating-linear-gradient(90deg, transparent, transparent 8px, rgba(139, 115, 85, 0.2) 8px, rgba(139, 115, 85, 0.2) 10px)',
              }}
            />
...
const SwatchOrderDialog = ({isOpen, onClose, selectedColor}) => {
  const [selectedSwatches, setSelectedSwatches] = useState([
    selectedColor?.id || 'swatch-1',
  ]);
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            See and feel our fabrics in your home before ordering. Up to 10
            samples FREE.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-6 pt-4">
          <div className="space-y-3">
            <Label className="text-sm font-medium">
              Select Colors ({selectedSwatches.length}/10)
            </Label>
            <div className="grid grid-cols-3 gap-3">
              {fabricSwatches.map((swatch) => (
                <button
                  ...
                  className={`relative p-3 rounded-xl border-2 transition-all text-left ${selectedSwatches.includes(swatch.id) ? 'border-primary bg-primary/5' : 'border-border hover:border-muted-foreground'}`}
                >
                  <div
          ...
          <div className="bg-accent/30 rounded-xl p-4 space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-muted-foreground">
                No return needed - samples are yours to keep
              </span>
            </div>
          </div>
...
export default function ProductDetailSafePage() {
  const {id} = useParams();
  ...
  const [openAccordion, setOpenAccordion] = useState('safety');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-center gap-2 text-sm">
            ...
            <span className="text-emerald-600 hidden sm:inline">
              — Cordless by default, safe for every room
            </span>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Order up to 10 FREE fabric swatches to see the natural
              ...
              <div className="flex gap-3 flex-wrap">
                {productData.colors.map((color) => (
                  <button
                    ...
                    className={`relative w-14 h-14 rounded-xl border-2 transition-all ${selectedColor.id === color.id ? 'border-primary ring-2 ring-primary ring-offset-2' : 'border-border hover:border-muted-foreground'}`}
        ...
        >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-emerald-900">
                        WCSC Certified Best for Kids
                      </h4>
                      <p className="text-sm text-emerald-700 mt-1">
                        Our cordless woven wood shades have been independently
                        tested and certified by the Window Covering Safety
                        Council as safe for homes with young children and pets.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {productData.safetyFeatures.map((feature, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className="p-4 rounded-xl bg-accent/30 space-y-2"
                      >
                ...
                <div className="relative rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                    <p className="text-white text-sm">
                      Our patented cordless lift system eliminates dangerous
                      exposed cords
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    {
                      label: 'Process',
                      value: productData.materialStory.process,
                    },
                    {
                      label: 'Craft Time',
                      value: productData.materialStory.time,
                    },
                    {
                      label: 'Impact',
                      value: productData.materialStory.sustainability,
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
            ...
            <AccordionContent className="pb-6">
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  Upgrade to our whisper-quiet motorized lift system for
                  ultimate convenience. Compatible with Alexa, Google Home, and
                  Apple HomeKit.
                </p>
                <MotorDemo />
          ...
          <AccordionItem value="swatches" className="border-b border-border">
            ...
            <AccordionContent className="pb-6">
              <div className="space-y-6">
                <p className="text-muted-foreground">
                  We highly recommend ordering fabric swatches before
                  purchasing. Natural materials can vary in color and texture,
              ...
              <table className="w-full">
                <tbody className="divide-y divide-border">
                  ...
                  <tr>
                    ...
                    <td className="py-3 text-sm font-medium">WCSC Certified</td>
                  </tr>
                  <tr>
                    <td className="py-3 text-sm text-muted-foreground">
                      Warranty
