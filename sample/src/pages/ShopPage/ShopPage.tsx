...
// ============================================
// Product Data with Color Swatches
// ============================================
...
const products: IProduct[] = [
  {
    ...
    hoverImage: 'https://miaoda.feishu.cn/aily/api/v1/files/static/190087f6844e4a6d9e9eecd6e38fdad3_ve_miaoda',
    material: 'Linen',
    badge: 'Best Seller',
    colors: [
  ...
  },
  {
    ...
    hoverImage: 'https://miaoda.feishu.cn/aily/api/v1/files/static/6d9f0df723de4f648a28c44f08db77d1_ve_miaoda',
    material: 'Linen',
    badge: 'New',
    colors: [
  ...
  },
  {
    ...
    rating: 4.6,
    reviewCount: 189,
    image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/6d9f0df723de4f648a28c44f08db77d1_ve_miaoda',
    material: 'Cotton',
    colors: [
  ...
  },
  {
    ...
    hoverImage: 'https://miaoda.feishu.cn/aily/api/v1/files/static/71c5a08726ba4857a88b02903542fc08_ve_miaoda',
    material: 'Velvet',
    badge: 'Premium',
    colors: [
  ...
  },
  {
    ...
    hoverImage: 'https://miaoda.feishu.cn/aily/api/v1/files/static/39ca6344fda4409e8177e7359d39c6f1_ve_miaoda',
    material: 'Silk',
    badge: 'Luxury',
    colors: [
...
// Shoppable Videos Data
const shoppableVideos = [
  {
    id: 'v1',
    thumbnail: 'https://miaoda.feishu.cn/aily/api/v1/files/static/39ca6344fda4409e8177e7359d39c6f1_ve_miaoda',
    productId: '1',
  ...
  {
    id: 'v2',
    thumbnail: 'https://miaoda.feishu.cn/aily/api/v1/files/static/190087f6844e4a6d9e9eecd6e38fdad3_ve_miaoda',
    productId: '4',
  ...
  {
    id: 'v3',
    thumbnail: 'https://miaoda.feishu.cn/aily/api/v1/files/static/5f909e47df72474caafcd3b191e077fd_ve_miaoda',
    productId: '7',
  ...
  {
    id: 'v4',
    thumbnail: 'https://miaoda.feishu.cn/aily/api/v1/files/static/6310ecde128b4463aff2428e6a1327a2_ve_miaoda',
    productId: '6',
...
// Filter options
const materialOptions = ['Linen', 'Cotton', 'Velvet', 'Silk', 'Wool Blend', 'Sheer Linen'];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-white/90 mb-6">
                Handcrafted from premium fabrics. Designed for your unique windows. 
                Free swatches available to see colors in your home.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                See colors and textures in your home before ordering. Free shipping on swatches.
              </p>
            </div>
            <div>
              <div className="w-12 h-12 mx-auto mb-4 bg-accent flex items-center justify-center">
              ...
              <p className="text-sm text-muted-foreground">
                Every curtain is handcrafted to your exact measurements. Perfect fit guaranteed.
              </p>
            </div>
            <div>
              <div className="w-12 h-12 mx-auto mb-4 bg-accent flex items-center justify-center">
              ...
              <p className="text-sm text-muted-foreground">
                Quick turnaround without compromising quality. Free shipping on orders over $200.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                something for every style and space. Each fabric is carefully selected 
                for quality, durability, and beautiful drape.
              </p>
              <ul className="space-y-3 mb-8">
                {['Linen - Natural & breathable', 'Cotton - Soft & versatile', 'Velvet - Rich & luxurious', 'Silk - Elegant & lustrous'].map((item) => (
            ...
            <div className="space-y-4">
              <div className="border border-border bg-card">
                <button className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-accent transition-colors">
                  <span className="font-medium">How do I choose the right fabric?</span>
                  <ChevronDownIcon className="w-5 h-5 text-muted-foreground" />
                </button>
                <div className="px-6 pb-4 text-muted-foreground text-sm">
                  Consider the room's function: linen and cotton are great for living spaces 
                  due to their breathability, while velvet adds luxury to bedrooms. For high 
                  sun exposure, choose fade-resistant fabrics. Order free swatches to see 
                  colors in your actual lighting.
                </div>
              </div>
              <div className="border border-border bg-card">
                <button className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-accent transition-colors">
                ...
                <div className="px-6 pb-4 text-muted-foreground text-sm">
                  All our curtains are custom-made to your exact measurements. We can accommodate 
                  widths from 20" to 300" and lengths from 24" to 144". Simply enter your 
                  dimensions during checkout, and we'll craft the perfect fit.
                </div>
              </div>
              <div className="border border-border bg-card">
                <button className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-accent transition-colors">
                  <span className="font-medium">How do I care for my curtains?</span>
                  <ChevronDownIcon className="w-5 h-5 text-muted-foreground" />
                </button>
                <div className="px-6 pb-4 text-muted-foreground text-sm">
                  Most fabrics can be dry cleaned. Linen and cotton may be machine washed 
                  on gentle cycle in cold water. Always check the care label. Regular 
                  vacuuming with a brush attachment helps maintain freshness.
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="border border-border bg-card">
                <button className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-accent transition-colors">
                  <span className="font-medium">What's your delivery timeline?</span>
                  <ChevronDownIcon className="w-5 h-5 text-muted-foreground" />
                </button>
                <div className="px-6 pb-4 text-muted-foreground text-sm">
                  Each order is handcrafted and takes 7-10 business days to produce. 
                  Shipping takes an additional 3-5 business days. You'll receive tracking 
                  information as soon as your order ships. Rush production available for a fee.
                </div>
              </div>
              <div className="border border-border bg-card">
                <button className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-accent transition-colors">
                ...
                <div className="px-6 pb-4 text-muted-foreground text-sm">
                  Since all items are custom-made to your specifications, we cannot accept 
                  returns. However, if there's a manufacturing defect, contact us within 
                  30 days for a free replacement. We recommend ordering swatches first.
                </div>
              </div>
              <div className="border border-border bg-card">
                <button className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-accent transition-colors">
                  <span className="font-medium">Do you offer installation?</span>
                  <ChevronDownIcon className="w-5 h-5 text-muted-foreground" />
                </button>
                <div className="px-6 pb-4 text-muted-foreground text-sm">
                  We provide detailed DIY installation guides and video tutorials. Installation 
                  is straightforward with basic tools. For complex projects, we can recommend 
                  local installers in select metropolitan areas.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-6 flex flex-col">
                ...
                <p className="text-muted-foreground mb-4">
                  Premium {quickViewProduct.material.toLowerCase()} curtains with 
                  elegant drape and lasting quality. Available in{' '}
