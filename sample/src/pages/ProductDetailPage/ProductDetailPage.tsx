...
const productData = {
  ...
  description: 'Our Classic Roman Shades combine timeless elegance with modern functionality. Handcrafted from premium fabrics, these shades offer beautiful light control and privacy while adding a sophisticated touch to any room. Each shade is custom-made to your exact specifications for a perfect fit.',
  basePrice: 151.99,
  ...
  rating: 4.5,
  reviewCount: 415,
  features: ['Custom sizes available', 'Free fabric swatches', 'Easy installation', 'Child-safe options', 'Motorization available'],
  colors: [
    ...
    { id: 'sage', name: 'Sage Green', hex: '#9CAF88', image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/6310ecde128b4463aff2428e6a1327a2_ve_miaoda' },
    ...
    { id: 'taupe', name: 'Warm Taupe', hex: '#8B7355', image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/4404b45f35da473c8fc6f026d2c13f56_ve_miaoda' },
  ],
  images: [
    { id: '1', url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/58c5b1e0bea9442eb4d1ea59746e3978_ve_miaoda', alt: 'Classic Roman Shades in living room' },
    { id: '2', url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/4404b45f35da473c8fc6f026d2c13f56_ve_miaoda', alt: 'Close-up fabric texture' },
    { id: '3', url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/cd2fb6ff06674ea6bc31045cd9354193_ve_miaoda', alt: 'Roman shades in home office' },
    { id: '4', url: 'https://miaoda.feishu.cn/aily/api/v1/files/static/45a1634fb4224db88c7dd3607cc2bbeb_ve_miaoda', alt: 'Bedroom with roman shades' },
  ],
  liningOptions: [
    { id: 'standard', name: 'Light Filtering', price: 0, description: 'Softens light while maintaining privacy and view' },
    { id: 'privacy', name: 'Privacy Lining', price: 15, description: 'Blocks visibility while allowing diffused light' },
    { id: 'blackout', name: 'Blackout', price: 35, description: 'Blocks 99% of light for complete darkness' },
  ],
  liftOptions: [
    { id: 'cordless', name: 'Cordless Lift', price: 0, description: 'Smooth operation by simply lifting/lowering the shade' },
    { id: 'continuous', name: 'Continuous Cord Loop', price: 20, description: 'Cord stays at same length, ideal for large shades' },
    { id: 'motorized', name: 'Motorized', price: 149, description: 'Remote control operation with smart home compatibility' },
  ],
};
...
const reviewsData = [
  {
    ...
    content: 'These shades exceeded my expectations. The fabric is thick and luxurious, and the custom fit is perfect. Installation was straightforward with the included hardware.',
    verified: true,
    helpful: 24,
    image: null,
  },
  {
    ...
    content: 'We ordered the blackout lining for our bedroom and it truly blocks out all light. The measuring guide was very helpful in getting the right size.',
    verified: true,
    helpful: 18,
  ...
  },
  {
    ...
    content: 'The shades are beautiful and well-made. Only complaint is shipping took longer than expected, but customer service was responsive when I reached out.',
    verified: true,
    helpful: 12,
    image: null,
  },
  {
    ...
    content: 'Ordered the sage color and it\'s exactly as shown on the website. The cordless lift works smoothly and looks modern in our living room.',
    verified: true,
    helpful: 15,
    image: null,
  },
  {
    ...
    content: 'This is my second set of roman shades from DrapeStyle. The quality is consistently excellent. Highly recommend ordering the fabric samples first to see colors in person.',
    verified: true,
    helpful: 22,
...
const relatedProducts = [
  { id: '2', name: 'Natural Linen Drapery', price: 129, image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/39ca6344fda4409e8177e7359d39c6f1_ve_miaoda', rating: 4.8 },
  { id: '3', name: 'Sheer White Panels', price: 89, image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/6d9f0df723de4f648a28c44f08db77d1_ve_miaoda', rating: 4.7 },
  { id: '4', name: 'Velvet Blackout Curtains', price: 189, image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/190087f6844e4a6d9e9eecd6e38fdad3_ve_miaoda', rating: 4.9 },
  { id: '5', name: 'Botanical Print Shades', price: 159, image: 'https://miaoda.feishu.cn/aily/api/v1/files/static/5f909e47df72474caafcd3b191e077fd_ve_miaoda', rating: 4.6 },
];
...
const MeasurementCalculator = () => {
  ...
  const calculateDimensions = () => {
    ...
    if (mountType === 'inside') {
      // For inside mount, subtract 1/4 inch for clearance
      setResult({
        width: (w - 0.25).toFixed(2),
        height: h.toFixed(2)
      });
    } else {
      // For outside mount, add 3-4 inches for overlap
      setResult({
        width: (w + 4).toFixed(2),
      ...
      <div className="space-y-3">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li className="flex items-start gap-2">
            ...
            Measure width at the top, middle, and bottom - use the narrowest measurement
          </li>
          <li className="flex items-start gap-2">
            <CheckIcon className="w-4 h-4 text-primary mt-0.5 shrink-0" />
            Measure height at the left, center, and right - use the longest measurement
          </li>
          <li className="flex items-start gap-2">
            <CheckIcon className="w-4 h-4 text-primary mt-0.5 shrink-0" />
...
const ProductDetailPage: React.FC<IProductDetailPageProps> = () => {
  ...
  const totalPrice = useMemo(() => {
    ...
    const unitPrice = (basePrice + liningPrice + liftPrice) * Math.max(sizeMultiplier, 0.7);
  ...
  const handleAddToCart = () => {
    const cartItem = {
      ...
      mounting: selectedLift.id as 'cordless' | 'continuous' | 'motorized',
      quantity,
  ...
  const filteredReviews = useMemo(() => {
    ...
    if (activeReviewFilter === 'verified') return reviewsData.filter(r => r.verified);
    if (activeReviewFilter === 'photos') return reviewsData.filter(r => r.image);
    if (activeReviewFilter === '5star') return reviewsData.filter(r => r.rating === 5);
    return reviewsData;
  }, [activeReviewFilter]);
    ...
    <div className="w-full space-y-16 md:space-y-24 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <button onClick={() => navigate('/shop')} className="hover:text-foreground transition-colors">Roman Shades</button>
          <ChevronRightIcon className="w-4 h-4" />
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="text-sm text-primary hover:underline ml-2">Write a Review</button>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              {/* Discount Info */}
              <div className="space-y-2">
                <p className="text-sm font-medium text-foreground">Eligible Discounts:</p>
                <div className="flex items-center gap-2">
                  <Badge className="bg-warning/10 text-warning border-0 rounded-full">
                    Take 30% Off $200+!
                  </Badge>
                  <span className="text-sm text-muted-foreground">Applied in cart.</span>
                  <button className="text-sm text-primary hover:underline">Details</button>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>Your custom-made shades will be ready in <strong className="text-foreground">8 - 10 business days</strong> and will ship upon completion.</span>
              </div>
            </div>

            <Separator />

            {/* Start Customizing Label */}
            <div className="flex items-center gap-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button className="text-xs text-primary hover:underline">Order Free Swatch</button>
              </div>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={selectedLift.id} onValueChange={(val) => {
                const lift = productData.liftOptions.find(l => l.id === val);
                if (lift) setSelectedLift(lift);
              }}>
                <div className="grid gap-3">
                  {productData.liftOptions.map((lift) => (
                    <div key={lift.id}>
                      <RadioGroupItem value={lift.id} id={lift.id} className="peer sr-only" />
                      <Label
                        htmlFor={lift.id}
                        className="flex items-start gap-3 p-4 rounded-xl border-2 border-border cursor-pointer transition-all peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5 hover:border-muted-foreground"
                      >
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">{lift.description}</p>
                        </div>
                      </Label>
                    </div>
                  ))}
            ...
            {/* Trust Badges - Moved above Add to Cart */}
            <div className="grid grid-cols-3 gap-3 py-2">
              <div className="flex flex-col items-center text-center gap-1.5 p-3 rounded-xl bg-accent/30">
                <PackageIcon className="w-5 h-5 text-primary" />
                <span className="text-xs text-muted-foreground">Free Shipping<br/>Orders $200+</span>
              </div>
              <div className="flex flex-col items-center text-center gap-1.5 p-3 rounded-xl bg-accent/30">
                <RotateCcwIcon className="w-5 h-5 text-primary" />
                <span className="text-xs text-muted-foreground">30-Day<br/>Satisfaction</span>
              </div>
              <div className="flex flex-col items-center text-center gap-1.5 p-3 rounded-xl bg-accent/30">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Accordion type="single" collapsible className="w-full" value={openAccordion} onValueChange={setOpenAccordion}>
              ...
              <div className="space-y-6">
                <table className="w-full">
                  <tbody className="divide-y divide-border">
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground w-1/3">Material</td>
                      <td className="py-3 text-sm font-medium">100% Premium Cotton / Linen Blend</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Min Width</td>
                      <td className="py-3 text-sm font-medium">12&quot;</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Max Width</td>
                      <td className="py-3 text-sm font-medium">120&quot;</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Min Height</td>
                      <td className="py-3 text-sm font-medium">12&quot;</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Max Height</td>
                      <td className="py-3 text-sm font-medium">120&quot;</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Fabric Weight</td>
                      <td className="py-3 text-sm font-medium">8 oz/yd²</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Care</td>
                      <td className="py-3 text-sm font-medium">Vacuum with brush attachment; spot clean only</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm text-muted-foreground">Origin</td>
                      <td className="py-3 text-sm font-medium">Made in USA with imported fabrics</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          {/* Measure and Install */}
          <AccordionItem value="measure-install" className="border-b border-border">
            <AccordionTrigger className="py-4 text-lg font-serif font-semibold hover:no-underline">
              Measure and Install
            </AccordionTrigger>
            <AccordionContent className="pb-6">
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <h5 className="text-sm font-medium text-muted-foreground">Inside Mount</h5>
                    ...
                    <div className="space-y-3">
                      <h5 className="text-sm font-medium text-muted-foreground">Outside Mount</h5>
                      <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Installation typically takes 15-30 minutes. All hardware and detailed instructions are included with your order.
                  </p>
                </div>
              </div>
            </AccordionContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Each shade is handcrafted to your exact specifications. Production typically takes <strong>8-10 business days</strong> before shipping.
                    </p>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-medium flex items-center gap-2">
                    ...
                    <ul className="space-y-1 text-sm text-muted-foreground">
                      <li>• <strong>Standard:</strong> 5-7 business days (FREE over $200)</li>
                      <li>• <strong>Express:</strong> 2-3 business days ($25)</li>
                      <li>• <strong>White Glove:</strong> Delivery & installation ($149)</li>
                    </ul>
                  </div>
                </div>
                <div className="bg-accent/30 rounded-xl p-4">
                  <p className="text-sm text-muted-foreground">
                    <strong>Important:</strong> Please inspect your shades upon delivery. For any issues, contact our customer service within 48 hours.
                  </p>
                </div>
              </div>
            </AccordionContent>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-accent/30 rounded-xl p-6 text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Based on {productData.reviewCount} reviews</div>
                    </div>
                        ...
                        <div key={item.stars} className="flex items-center gap-3">
                          ...
                          <div className="flex-1 h-2 bg-accent rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${(item.count / productData.reviewCount) * 100}%` }}
                            />
                          </div>
                    ...
                    {/* Review Filters */}
                    <div className="space-y-2">
                      <Label className="text-sm font-medium">Filter Reviews</Label>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <h2 className="font-serif text-2xl md:text-3xl font-semibold">You May Also Like</h2>
            ...
            {relatedProducts.map((product) => (
              ...
              >
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-primary font-semibold">From ${product.price}</span>
