...
// ============================================
const ProductDetailShadesPage: React.FC = () => {
  ...
  // Accordion states
  const [openSections, setOpenSections] = useState<string[]>(['color', 'mount', 'dimensions']);
  ...
  }, [selectedMountType, selectedLiftStyle, selectedLining, selectedBinding, selectedNoDrill, width, height, quantity]);
  ...
  const handleAddToCart = () => {
    const cartItem = {
      ...
      lining: selectedLining.id as 'light-filtering' | 'room-darkening' | 'blackout',
      mounting: selectedMountType.id as 'inside' | 'outside',
      quantity,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 pb-6 border-b border-gray-200">
              ...
              <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900 leading-tight">Custom Roller Shades</h1>
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-3">
                    ...
                    {productColors.map((color) => (
                      ...
                      >
                        {selectedColor.id === color.id && (
                          <CheckIcon className={`absolute inset-0 m-auto w-4 h-4 ${['#FFFFFF', '#F5F5DC', '#FFFDD0', '#F4C2C2', '#D3D3D3'].includes(color.hex) ? 'text-slate-800' : 'text-white'}`} />
                        )}
                      </button>
                    ))}
                  </HorizontalScroll>
              ...
              >
                <div className="pt-4 space-y-3">
                  <RadioGroup value={selectedMountType.id} onValueChange={(val) => { const mount = mountTypes.find(m => m.id === val); if (mount) setSelectedMountType(mount); }}>
                    <div className="space-y-3">
                ...
                <div className="pt-4 space-y-4">
                  ...
                  <div className="bg-gray-50 border border-gray-200 p-4">
                    ...
                    <div className="aspect-[16/9] bg-gray-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center">
                      ...
                      <p className="text-xs text-gray-400 mt-1">Shows how to measure for {selectedMountType.id} mount</p>
                    </div>
              ...
              >
                <div className="pt-4 space-y-3">
                  <RadioGroup value={selectedBinding.id} onValueChange={(val) => { const binding = bindingOptions.find(b => b.id === val); if (binding) setSelectedBinding(binding); }}>
                    <div className="space-y-2">
              ...
              >
                <div className="pt-4 space-y-3">
                  <RadioGroup value={selectedNoDrill.id} onValueChange={(val) => { const option = noDrillUpgrade.find(o => o.id === val); if (option) setSelectedNoDrill(option); }}>
                    <div className="space-y-2">
