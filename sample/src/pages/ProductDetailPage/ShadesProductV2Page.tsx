...
// ============================================
// Product Data - Shades V2 with FIT Protection
// ============================================
const productData = {
  id: 'shades-roller-v2',
  ...
  // Technical specs with concrete details
  technicalSpecs: {
...
const mountTypes = [
  { 
    ...
    name: 'Inside Mount', 
    price: 0, 
    description: 'Fits within your window frame. Requires 2" minimum depth. Clean, built-in look.',
  ...
  { 
    ...
    name: 'Outside Mount', 
    price: 0, 
    description: 'Mounts on the wall above window. Better light blocking, makes window appear larger.',
...
const liftTypes = [
  { id: 'standard', name: 'Standard Cord', price: 0, description: 'Traditional pull cord operation' },
  { id: 'cordless', name: 'Cordless Lift', price: 25, description: 'Push up, pull down - no cords' },
  { id: 'motorized', name: 'Motorized', price: 149, description: 'Remote control & smart home compatible' },
];

const valanceTypes = [
  { id: 'none', name: 'No Valance', price: 0 },
  { id: 'cassette', name: 'Cassette Valance', price: 35, description: 'Fabric-covered headrail for finished look' },
  { id: 'exposed', name: 'Exposed Roll', price: 0, description: 'Minimal, industrial aesthetic' },
];

// ============================================
// FIT Protection Component
// ============================================
      ...
      <div className="bg-[hsl(220_25%_97%)] border border-[hsl(220_25%_90%)] p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-sm text-foreground">FIT Protection: Measuring Guarantee Included</p>
              <p className="text-xs text-muted-foreground">Free replacement if measurements are wrong</p>
            </div>
          </div>
          <button 
          ...
          <div className="py-6 space-y-6">
            <div className="bg-[hsl(220_25%_97%)] p-4 border border-[hsl(220_25%_90%)]">
              <p className="text-sm leading-relaxed">
                "Measure with ease. If you make a mistake, we've got you covered. 
                <span className="font-semibold"> One-time free replacement per blind.</span> 
            ...
            <div className="space-y-4">
              ...
              <ol className="space-y-3 text-sm">
                <li className="flex gap-3">
                  <span className="w-5 h-5 bg-[hsl(220_25%_25%)] text-white text-xs flex items-center justify-center shrink-0">1</span>
                  <span>Contact our support team with your order number</span>
                </li>
                <li className="flex gap-3">
                  <span className="w-5 h-5 bg-[hsl(220_25%_25%)] text-white text-xs flex items-center justify-center shrink-0">2</span>
                  <span>Provide corrected measurements</span>
                </li>
                <li className="flex gap-3">
                  <span className="w-5 h-5 bg-[hsl(220_25%_25%)] text-white text-xs flex items-center justify-center shrink-0">3</span>
                  <span>We remake and ship your replacement within 10 days</span>
                </li>
              </ol>
            </div>
            ...
            <div className="pt-4 border-t">
              <p className="text-xs text-muted-foreground">
                * FIT Protection applies to standard products. Specialty items excluded. 
                Replacement must be same style, fabric, and opacity.
              </p>
            </div>
          </div>
        </SheetContent>
...
// ============================================
// Dimension Input with Confirmation
// ============================================
    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <Button
          ...
          disabled={!isValid}
          onClick={onConfirm}
          className={confirmed ? 'bg-[hsl(220_25%_25%)] text-white hover:bg-[hsl(220_25%_20%)]' : ''}
        >
          {confirmed ? (
            <>
...
// ============================================
// Technical Specs with Exploded View
// ============================================
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-4 bg-[hsl(220_25%_97%)] border border-[hsl(220_25%_90%)]">
          ...
          <p className="font-semibold text-sm">{productData.technicalSpecs.material}</p>
          <p className="text-xs text-muted-foreground mt-1">{productData.technicalSpecs.composition}</p>
        </div>
        <div 
        ...
        >
          ...
          <p className="font-semibold text-sm">{productData.technicalSpecs.thickness}</p>
          <p className="text-xs text-[hsl(220_25%_35%)] mt-1 group-hover:underline">View texture detail →</p>
        </div>
        <div className="p-4 bg-[hsl(220_25%_97%)] border border-[hsl(220_25%_90%)]">
          <p className="text-xs text-muted-foreground mb-1">UV Protection</p>
          <p className="font-semibold text-sm">{productData.technicalSpecs.uvProtection}</p>
        </div>
        <div className="p-4 bg-[hsl(220_25%_97%)] border border-[hsl(220_25%_90%)]">
          <p className="text-xs text-muted-foreground mb-1">Roller Mechanism</p>
          <p className="font-semibold text-sm">{productData.technicalSpecs.mechanism}</p>
        </div>
      </div>
      ...
      <Dialog open={showTexture} onOpenChange={setShowTexture}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Fabric Texture: {productData.technicalSpecs.material}</DialogTitle>
            <DialogDescription>
...
const ShadesProductV2Page: React.FC = () => {
  ...
  // Dimension states with confirmation
  ...
  const totalPrice = useMemo(() => {
    ...
    return (base + mountPrice + opacityPrice + liftPrice + valancePrice) * quantity;
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      lining: selectedOpacity.id === 'blackout' ? 'blackout' : selectedOpacity.id === 'sheer' ? 'privacy' : 'light-filtering',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              {productData.images.map((img, i) => (
                <button
                  ...
                  className={`w-20 h-20 overflow-hidden border-2 ${
                    i === currentImage ? 'border-[hsl(220_25%_25%)]' : 'border-transparent'
                  }`}
                >
          ...
          <div className="space-y-6">
            {/* Header */}
            <div>
              <h1 className="font-serif text-3xl font-semibold mb-2">{productData.name}</h1>
            ...
            <div className="pt-4 border-t">
              <div className="flex items-baseline gap-2">
                ...
                {quantity > 1 && (
                  <span className="text-muted-foreground">(${((totalPrice / quantity)).toFixed(2)} each)</span>
                )}
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <Label className="text-sm font-medium">Fabric Color: {selectedColor.name}</Label>
              </div>
                ...
                {productColors.map((color) => (
                  <button
                    ...
                    className={`w-10 h-10 border-2 ${
                      selectedColor.id === color.id ? 'border-[hsl(220_25%_25%)]' : 'border-border'
                    }`}
                    style={{ backgroundColor: color.hex }}
                    title={color.name}
                  >
                    {selectedColor.id === color.id && (
                      <CheckIcon className={`h-5 w-5 mx-auto ${color.hex === '#FFFFFF' || color.hex === '#F5F5DC' || color.hex === '#FFFDD0' ? 'text-black' : 'text-white'}`} />
                    )}
                  </button>
                ))}
              </div>
              
              {/* Prominent Swatches Button */}
              <Button
                variant="outline"
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              <RadioGroup 
                ...
                onValueChange={(val) => setSelectedMount(mountTypes.find(m => m.id === val)!)}
                ...
                {mountTypes.map((mount) => (
                  <div key={mount.id}>
                    ...
                    >
                      ...
                      <span className="text-xs text-muted-foreground mt-1">{mount.description}</span>
                    </Label>
                  </div>
                ))}
              </RadioGroup>
            ...
            {/* Dimensions with FIT Protection */}
            <div className="space-y-4 pt-4 border-t">
              ...
              <div className="grid grid-cols-2 gap-4">
                <DimensionInput
                  ...
                  value={width}
                  onChange={(val) => { setWidth(val); setWidthConfirmed(false); }}
                  min={12}
                  max={120}
                ...
                <DimensionInput
                  ...
                  value={height}
                  onChange={(val) => { setHeight(val); setHeightConfirmed(false); }}
                  min={12}
                  max={120}
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              <RadioGroup 
                ...
                onValueChange={(val) => setSelectedOpacity(opacityTypes.find(o => o.id === val)!)}
                className="grid grid-cols-2 gap-3"
              >
                {opacityTypes.map((opacity) => (
                  <div key={opacity.id}>
                    <RadioGroupItem value={opacity.id} id={opacity.id} className="peer sr-only" />
                    <Label
                      htmlFor={opacity.id}
                      className="flex flex-col p-4 border border-border cursor-pointer peer-data-[state=checked]:border-[hsl(220_25%_25%)] peer-data-[state=checked]:bg-[hsl(220_25%_97%)] hover:bg-accent/50"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {opacity.price > 0 && <span className="text-sm">+${opacity.price}</span>}
                      </div>
                      <span className="text-xs text-muted-foreground mt-1">{opacity.description}</span>
                      <span className="text-xs text-[hsl(220_25%_35%)] mt-1">{opacity.lightBlock}</span>
                    </Label>
                  </div>
                ))}
              </RadioGroup>
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              <RadioGroup 
                ...
                onValueChange={(val) => setSelectedLift(liftTypes.find(l => l.id === val)!)}
                className="space-y-2"
              >
                {liftTypes.map((lift) => (
                  <div key={lift.id}>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-xs text-muted-foreground block mt-0.5">{lift.description}</span>
                      </div>
                      {lift.price > 0 ? <span className="text-sm font-medium">+${lift.price}</span> : <span className="text-sm text-muted-foreground">Included</span>}
                    </Label>
                  </div>
                ))}
              </RadioGroup>
            ...
            {/* Valance */}
            <div className="space-y-3 pt-4 border-t">
              <Label className="text-sm font-medium">Valance / Headrail Style</Label>
              <RadioGroup 
                value={selectedValance.id} 
                onValueChange={(val) => setSelectedValance(valanceTypes.find(v => v.id === val)!)}
                className="space-y-2"
              >
                {valanceTypes.map((valance) => (
                  <div key={valance.id}>
                    <RadioGroupItem value={valance.id} id={valance.id} className="peer sr-only" />
                    <Label
                      htmlFor={valance.id}
                      className="flex items-center justify-between p-4 border border-border cursor-pointer peer-data-[state=checked]:border-[hsl(220_25%_25%)] peer-data-[state=checked]:bg-[hsl(220_25%_97%)] hover:bg-accent/50"
                    >
                      <div>
                        ...
                        {valance.description && <span className="text-xs text-muted-foreground block mt-0.5">{valance.description}</span>}
                      </div>
                      {valance.price > 0 ? <span className="text-sm font-medium">+${valance.price}</span> : <span className="text-sm text-muted-foreground">Included</span>}
                    </Label>
                  </div>
                ))}
              </RadioGroup>
            ...
            {/* Trust Badges before Add to Cart */}
            <CartTrustBadges />
              ...
              <AccordionContent className="space-y-4">
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="p-4 bg-[hsl(220_25%_97%)]">
                    ...
                    <p className="text-sm text-muted-foreground">14 business days + 3-5 days shipping</p>
                  </div>
                  <div className="p-4 bg-[hsl(220_25%_97%)]">
                    <RotateCcwIcon className="h-6 w-6 mb-2 text-[hsl(220_25%_35%)]" />
                    <p className="font-medium">Returns</p>
                    <p className="text-sm text-muted-foreground">Custom items: FIT Protection applies</p>
                  </div>
                  <div className="p-4 bg-[hsl(220_25%_97%)]">
                    <ShieldCheckIcon className="h-6 w-6 mb-2 text-[hsl(220_25%_35%)]" />
                    <p className="font-medium">Warranty</p>
                    <p className="text-sm text-muted-foreground">5-year mechanism, 3-year fabric</p>
                  </div>
                </div>
              </AccordionContent>
            </AccordionItem>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <CheckIcon className="h-4 w-4 text-[hsl(220_25%_35%)] mt-0.5 shrink-0" />
                <span>Measure width at top, middle, and bottom. Use the narrowest.</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckIcon className="h-4 w-4 text-[hsl(220_25%_35%)] mt-0.5 shrink-0" />
                <span>Measure height at left, center, and right. Use the shortest.</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckIcon className="h-4 w-4 text-[hsl(220_25%_35%)] mt-0.5 shrink-0" />
            ...
            <Button 
              className="w-full" 
              onClick={() => { setShowFitInfo(false); navigate('/guides/measure'); }}
            >
