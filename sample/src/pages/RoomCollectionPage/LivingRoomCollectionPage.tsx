...
const roomData = {
  ...
  metaDescription: 'Discover perfect window treatments for your living room. From light-filtering sheers to blackout drapes, find stylish solutions for comfort and privacy.',
  heroImage: 'https://miaoda.feishu.cn/aily/api/v1/files/static/d6e513cd18d543ba880d3432113b8457_ve_miaoda',
  description: 'The living room is the heart of your home—a space for relaxation, entertainment, and connection. The right window treatments balance natural light, privacy, and style to create an inviting atmosphere that reflects your personal taste.',
  whyThisRoom: [
    {
      icon: SunIcon,
      title: 'Light Control',
...
// Curated recommendations for living room
const recommendations = [
  {
    id: 'sheer-drapes',
    name: 'Sheer Linen Drapes',
    tagline: 'Soft Light & Airy Feel',
    description: 'Perfect for living rooms that need gentle light diffusion while maintaining an open, spacious feel.',
    ...
    colors: ['White', 'Cream', 'Soft Gray', 'Beige'],
  },
  {
    id: 'cellular-shades',
    name: 'Cellular Shades',
    tagline: 'Energy Efficiency Meets Style',
    description: 'Honeycomb design traps air for insulation while providing excellent light control and privacy.',
    ...
    colors: ['White', 'Alabaster', 'Gray', 'Tan'],
  },
  {
    id: 'layered-curtains',
    name: 'Layered Curtains',
    tagline: 'Maximum Versatility',
    description: 'Combine sheer panels with blackout drapes for ultimate control—light and airy by day, cozy and private by night.',
...
const galleryImages = [
  {
    ...
    caption: 'Floor-to-ceiling sheers create an airy, expansive feel in contemporary living spaces.',
  },
  {
    id: 2,
    ...
    caption: 'Layering sheers with blackout drapes offers versatility for day-to-night transitions.',
  },
  {
    id: 3,
    ...
    caption: 'Clean-lined cellular shades complement minimalist interiors while improving energy efficiency.',
  },
  {
    id: 4,
    ...
    caption: 'Rich velvet drapes add warmth and sophistication to classic living room designs.',
  },
];
...
const stylingTips = [
  {
    ...
    content: 'Choose curtain colors that complement your wall color while adding depth. For neutral walls, consider curtains 2-3 shades darker. For colorful walls, opt for neutral window treatments to balance the space.',
  },
  {
    title: 'Mount High & Wide',
    content: 'Hang curtains 6-12 inches above the window frame and extend 3-6 inches beyond the sides. This creates the illusion of larger windows and makes ceilings feel higher.',
  },
  {
    title: 'Layer for Versatility',
    content: 'Combine sheer panels for daytime privacy with blackout curtains for evening comfort. This layered approach provides flexibility for any activity or time of day.',
  },
];
...
const faqData = [
  {
    ...
    answer: 'Sheer or light-filtering shades are ideal for preserving views while providing daytime privacy. Consider top-down/bottom-up cellular shades that can be lowered from the top to maintain your view while covering the lower portion for privacy. Layer with side drapes for evening privacy.',
  },
  {
    question: 'How do I reduce glare on my TV while keeping natural light?',
    answer: 'Roller shades with a solar screen fabric (1-5% openness) block glare while preserving your view and natural light. Alternatively, sheer curtains diffuse light beautifully. Motorized options let you adjust throughout the day as the sun moves.',
  },
  {
    question: 'Should curtains touch the floor in a living room?',
    answer: 'Yes, floor-length curtains create a polished, intentional look. For a modern aesthetic, let them "kiss" the floor (just touch). For a more traditional or luxurious feel, allow 1-2 inches of fabric to pool on the floor. Avoid curtains that hover above the floor as they appear unfinished.',
  },
  {
    question: 'What\'s the difference between curtains and drapes?',
    answer: 'Curtains are typically lighter, unlined fabrics that filter light. Drapes are heavier, lined fabrics designed to block light and provide insulation. For living rooms, many homeowners choose lighter curtains for a casual feel or lined drapes for formal spaces and better light control.',
  },
  {
    question: 'How do I measure for living room curtains?',
    answer: 'For width: Measure the window width and add 6-12 inches (3-6 inches per side) for proper coverage. For length: Measure from the rod position (6-12 inches above window) to your desired endpoint—either floor-grazing or puddling. Always measure twice and consider inside vs outside mount options.',
  },
  {
    question: 'Can I mix different window treatments in the same living room?',
    answer: 'Absolutely! Many designers recommend using complementary treatments—perhaps cellular shades on smaller windows for consistency and curtains on the main focal window for impact. Keep the color palette cohesive and vary textures rather than introducing competing patterns.',
  },
];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          The right choice enhances comfort, functionality, and style in your most-used space.
        </p>
      </div>
    ...
    <section className="py-16 md:py-20 bg-[hsl(220_10%_97%)]" id="recommendations">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Our experts recommend these styles based on typical {roomData.name.toLowerCase()} needs and design trends.
          </p>
        </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-3 border-t border-border">
                    <p className="text-xs text-muted-foreground">
                      <span className="font-medium text-foreground">Best for:</span> {rec.bestFor}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative aspect-[3/4] overflow-hidden bg-muted mb-3">
                ...
                {product.tag && (
                  <div className="absolute top-2 left-2">
                    <Badge className="bg-[hsl(220_15%_25%)] text-white text-[10px]">{product.tag}</Badge>
                  </div>
                )}
              </div>
    ...
    <section className="py-16 md:py-20 bg-[hsl(220_10%_97%)]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground">
            Everything you need to know about {roomData.name.toLowerCase()} window treatments.
          </p>
        </div>
        <div className="space-y-3">
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Button variant="outline" size="sm" onClick={() => window.open('tel:18005892333', '_self')}>
...
const LivingRoomCollectionPage: React.FC = () => {
  return (
