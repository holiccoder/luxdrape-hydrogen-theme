...
const benefits = [
  {
    icon: GiftIcon,
    title: 'Free Products',
    description: 'Receive complimentary custom curtains for your home or projects valued up to $1,000',
  },
  {
    icon: DollarSignIcon,
    title: 'Commission',
    description: 'Earn 15% commission on every sale made through your unique referral link',
  },
  {
    icon: UsersIcon,
    title: 'Exclusive Access',
    description: 'Early access to new collections and limited edition fabrics before public launch',
  },
  {
    icon: StarIcon,
    title: 'Featured Content',
    description: 'Get featured on our official Instagram and website reaching 500K+ followers',
  },
];
...
const processSteps = [
  {
    step: '01',
    title: 'Apply',
    description: 'Fill out our simple application form with your social media handles and content samples',
  },
  {
    step: '02',
    title: 'Review',
    description: 'Our team reviews your application and audience alignment within 5-7 business days',
  },
  {
    step: '03',
    title: 'Welcome',
    description: 'Receive your welcome package with product selection guide and brand guidelines',
  },
  {
    step: '04',
    title: 'Create',
    description: 'Receive your custom curtains and start creating beautiful content for your audience',
  },
];
...
const InfluencerPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success('Application submitted! We\'ll review and get back to you within 5-7 days.');
  };
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8 leading-relaxed">
                Join our community of home decor creators and share the beauty of custom 
                window treatments with your audience. Get free products, earn commissions, 
                and inspire others.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We value our creators and offer competitive benefits to help you grow 
              while sharing beautiful products with your audience.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit) => (
              <div key={benefit.title} className="border border-border p-6 bg-card">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                We partner with authentic creators who share our passion for quality 
                home decor and exceptional design.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="border border-border bg-card p-6 text-center">
                  <InstagramIcon className="h-8 w-8 mx-auto mb-3 text-[hsl(220_25%_35%)]" />
              ...
              <div className="space-y-4 pt-8">
                <div className="border border-border bg-card p-6 text-center">
                  <YoutubeIcon className="h-8 w-8 mx-auto mb-3 text-[hsl(220_25%_35%)]" />
      ...
      <section className="w-full py-16 md:py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Getting started is simple. Follow these steps to become a LuxDrape partner.
            </p>
          </div>
      ...
      <section className="w-full py-16 md:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              See what our community members are saying about their partnership with LuxDrape.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {featuredCreators.map((creator) => (
              <div key={creator.handle} className="border border-border bg-card">
                ...
                <div className="p-6">
                  <p className="text-muted-foreground italic mb-4">"{creator.quote}"</p>
          ...
          <form onSubmit={handleSubmit} className="border border-border bg-card p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <Input id="followers" placeholder="e.g. 50,000" className="mt-2" />
              </div>
            </div>

            <div className="mb-6">
              <Label htmlFor="otherSocial">Other Social Platforms (Optional)</Label>
              <Input id="otherSocial" placeholder="TikTok, YouTube, Blog URL" className="mt-2" />
            </div>
            ...
            <Button type="submit" className="w-full bg-[hsl(220_25%_25%)] hover:bg-[hsl(220_25%_20%)]">
